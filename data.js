...
const SPECIALS={iam:{goal:'Dominar identidade e acesso de ponta a ponta, do protocolo à arquitetura.',prereqs:['Redes TCP/IP','Windows / Linux','Fundamentos de Segurança'],labs:['Criar tenant Entra e ciclo de usuários','Configurar MFA + Conditional Access','Implementar SSO SAML e OIDC','AD DS + Entra Connect','RBAC + PIM + JIT','Criar workload identity e testar Graph'],deep:['Kerberos','OAuth 2.0 / OIDC avançado','Identity Threats','Workload Identity','IAM Architecture']},iga:{goal:'Governar o ciclo de vida e as permissões de identidades.',prereqs:['IAM','RBAC','GRC básico'],labs:['Joiner/Mover/Leaver','Provisionamento automático','Access Review','Entitlement Management','SoD matrix'],deep:['SailPoint','Access Certification','Role Mining','Identity Analytics']},pam:{goal:'Controlar, proteger e auditar acesso privilegiado.',prereqs:['IAM','Windows / Linux','Security Fundamentals'],labs:['Entra PIM','JIT activation','Vault workflow','Privileged session','Break-glass account'],deep:['CyberArk','BeyondTrust','JEA','Credential rotation','PAM architecture']}};
const ROADMAP_META={
start:{title:'Ponto de partida',description:'Siga a ordem sugerida. Não tente estudar todos os domínios ao mesmo tempo.',steps:[['01','Fundamentos de TI','Construa a base técnica: sistemas operacionais, redes, virtualização, shell e segurança.','fundamentals'],['02','Cloud & Infraestrutura','Aprenda infraestrutura moderna e Azure antes de aprofundar os controles de segurança cloud.','cloud'],['03','IAM','Domine identidade, autenticação, autorização, protocolos e identidade híbrida.','iam'],['04','IGA + PAM','Separe governança do ciclo de vida de identidade de controle de privilégios.','iga'],['05','Endpoint + Security Operations','Aprenda gestão de dispositivos, SIEM, EDR/XDR e resposta operacional.','endpoint'],['06','GRC + Data Security','Conecte controles técnicos a risco, conformidade e proteção de dados.','grc']]},
fundamentals:{order:['Sistemas Operacionais','Redes TCP/IP','Virtualização','PowerShell / Bash','Python / APIs','Fundamentos de Segurança'],areas:{'Sistemas Operacionais':{summary:'Aprenda como os sistemas funcionam, são administrados e protegidos.',systems:['Windows','Linux','macOS'],path:['Arquitetura e componentes','Processos e threads','Memória e armazenamento','Usuários, grupos e permissões','Serviços e inicialização','Logs e troubleshooting','Hardening e segurança']},'Redes TCP/IP':{summary:'Entenda a comunicação antes de avançar para cloud, IAM e segurança de rede.',path:['OSI e TCP/IP','IPv4 / IPv6','ARP e ICMP','DNS','DHCP','TCP / UDP','Routing e switching','NAT','HTTP / HTTPS','VPN']}},
cloud:{order:['Cloud Fundamentals','Azure','Compute','Storage','Networking','Governance','Hybrid Infrastructure','IaC']},
iam:{order:['Authentication','Authorization','RBAC / ABAC','MFA / Passwordless','SSO / Federation','SAML / OAuth / OIDC','Microsoft Entra ID','Active Directory','Hybrid Identity','Workload Identity','Identity Security']},
iga:{order:['Identity Lifecycle','Joiner / Mover / Leaver','Provisioning','Access Requests','Access Reviews','Access Certification','Entitlement Management','Segregation of Duties']},
pam:{order:['Privileged Accounts','PIM','JIT / JEA','Credential Vaulting','Privileged Sessions','CyberArk','BeyondTrust']},
soc:{order:['SOC Fundamentals','SIEM','Microsoft Sentinel','Splunk','KQL','SOAR','EDR / XDR','Detection Engineering','Threat Hunting','MITRE ATT&CK']},
grc:{order:['Governance','Risk Assessment','Risk Treatment','Security Controls','NIST CSF 2.0','ISO 27001','NIST 800-53','CIS Controls','Audit','LGPD / GDPR / SOX','Third-Party Risk','Security Metrics']}
};
